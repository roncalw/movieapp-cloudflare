...
export const SCHEDULED_TMDB_PROVIDER_REFRESH_CRON = "0 19,20 * * TUE,THU,SAT";
export const SCHEDULED_TMDB_POPULARITY_CRON = "0 7 * * 1";
export const SCHEDULED_MOVIE_LIST_BUILD_CRON = "0 10 * * 1";
export const SCHEDULED_CACHE_WARM_ALL_GENRES_CRON = "0 11 * * 1";
export const SCHEDULED_WEEKLY_IMPORT_VALIDATION_CRON = "0 13 * * 1";
